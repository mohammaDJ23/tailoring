        ...
        <Col>
          <FormControl fullWidth>
            ...
            <Inpt
              ...
              type="number"
              onChange={event => changeInput({ form: Form.CREATE_NEW_PANTS, input: Input.HEIGHT, value: event.target.value })}
              fullWidth
            />
        ...
        <Col>
          <FormControl fullWidth>
            ...
            <Inpt
              ...
              type="number"
              onChange={event => changeInput({ form: Form.CREATE_NEW_PANTS, input: Input.WAIST, value: event.target.value })}
              fullWidth
            />
        ...
        <Col>
          <FormControl fullWidth>
            ...
            <Inpt
              ...
              type="number"
              onChange={event => changeInput({ form: Form.CREATE_NEW_PANTS, input: Input.SEAT, value: event.target.value })}
              fullWidth
            />
        ...
        <Col>
          <FormControl fullWidth>
            ...
            <Inpt
              ...
              type="number"
              onChange={event => changeInput({ form: Form.CREATE_NEW_PANTS, input: Input.THIGHT, value: event.target.value })}
              fullWidth
            />
        ...
        <Col>
          <FormControl fullWidth>
            ...
            <Inpt
              ...
              type="number"
              onChange={event => changeInput({ form: Form.CREATE_NEW_PANTS, input: Input.KNEE, value: event.target.value })}
              fullWidth
            />
        ...
        <Col>
          <FormControl fullWidth>
            ...
            <Inpt
              ...
              type="number"
              onChange={event => changeInput({ form: Form.CREATE_NEW_PANTS, input: Input.PANT_SLIPPER, value: event.target.value })}
              fullWidth
            />
        ...
        <Col>
          <FormControl fullWidth>
            ...
            <Inpt
              ...
              type="number"
              onChange={event => changeInput({ form: Form.CREATE_NEW_PANTS, input: Input.HIP, value: event.target.value })}
              fullWidth
            />
