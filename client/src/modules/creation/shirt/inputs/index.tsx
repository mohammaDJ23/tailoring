        ...
        <Col>
          <FormControl fullWidth>
            ...
            <Inpt
              ...
              type="number"
              onChange={event => changeInput({ form: Form.CREATE_NEW_SHIRT, input: Input.HEIGHT, value: event.target.value })}
              fullWidth
            />
        ...
        <Col>
          <FormControl fullWidth>
            ...
            <Inpt
              ...
              type="number"
              onChange={event => changeInput({ form: Form.CREATE_NEW_SHIRT, input: Input.SHOULDER, value: event.target.value })}
              fullWidth
            />
        ...
        <Col>
          <FormControl fullWidth>
            ...
            <Inpt
              ...
              type="number"
              onChange={event => changeInput({ form: Form.CREATE_NEW_SHIRT, input: Input.SLEEVE, value: event.target.value })}
              fullWidth
            />
        ...
        <Col>
          <FormControl fullWidth>
            ...
            <Inpt
              ...
              type="number"
              onChange={event => changeInput({ form: Form.CREATE_NEW_SHIRT, input: Input.SLEEVE_RING, value: event.target.value })}
              fullWidth
            />
        ...
        <Col>
          <FormControl fullWidth>
            ...
            <Inpt
              ...
              type="number"
              onChange={event => changeInput({ form: Form.CREATE_NEW_SHIRT, input: Input.ARMPIT, value: event.target.value })}
              fullWidth
            />
        ...
        <Col>
          <FormControl fullWidth>
            ...
            <Inpt
              ...
              type="number"
              onChange={event => changeInput({ form: Form.CREATE_NEW_SHIRT, input: Input.CHEST, value: event.target.value })}
              fullWidth
            />
        ...
        <Col>
          <FormControl fullWidth>
            ...
            <Inpt
              ...
              type="number"
              onChange={event => changeInput({ form: Form.CREATE_NEW_SHIRT, input: Input.COLLAR, value: event.target.value })}
              fullWidth
            />
